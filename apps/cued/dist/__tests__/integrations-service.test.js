...
import { completeAuthSession, getAuthSessionSummary, listIntegrationStates, listRequestableIntegrationPlatforms, markAuthSessionInProgress, refreshManagedIntegrationStates, requestIntegrationAccess, setIntegrationEnabled, } from "../integrations/service.js";
describe("integration state management", () => {
    ...
    it("refreshes managed integrations and creates managed auth sessions for browser platforms", () => {
        ...
        expect(listIntegrationStates(db)).toEqual(expect.arrayContaining([
        ...
        expect(requested.integration.metadata).toEqual(expect.objectContaining({
        ...
        expect(() => requestIntegrationAccess(db, "gmail")).toThrow("Unsupported integration platform: gmail");
        expect(() => requestIntegrationAccess(db, "discord")).toThrow("Unsupported integration request: discord");
        db.close();
    });
});
//# sourceMappingURL=integrations-service.test.js.map