          ...
          <div className="grid gap-12 sm:grid-cols-3">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                All your conversations in one place. iMessage, Gmail, and Slack
                unified.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Smart suggestions for follow-ups. Swipe to respond, snooze, or
                dismiss.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                AI remembers your relationships. Ask about past conversations
                naturally.
              </p>
            </div>
          </div>
