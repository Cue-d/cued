...
import { type Attachment, PreviewAttachment } from '@/components/PreviewAttachment'
  ...
  return (
    <div className={cn('relative flex w-full flex-col gap-4', className)}>
      ...
      <motion.div
        ...
        className="relative overflow-hidden border border-imessage-input-border bg-imessage-input-bg shadow-xs"
        initial={false}
      ...
      >
        ...
        >
          <PromptInputTextarea
            className="flex-1 resize-none border-0! border-none! bg-transparent px-2 py-1 text-[15px] outline-none ring-0 [-ms-overflow-style:none] [scrollbar-width:none] placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 [&::-webkit-scrollbar]:hidden"
          ...
          <PromptInputToolbar className="shrink-0 border-t-0! p-0 shadow-none">
            <PromptInputTools className="gap-0.5">
              <Button
                className="aspect-square h-8 rounded-lg p-1 transition-colors hover:bg-sidebar-accent"
