  ...
  > = [
    {
      ...
      payload: {
        ...
        sourceProfileUrl: "addressbook://ava",
        handles: [
    ...
    },
    {
      ...
      payload: {
        ...
        sourceProfileUrl: "https://linkedin.example/in/ava",
        handles: [
          { type: "email", value: "ava@cued.com", deterministic: true },
    ...
    },
    {
      ...
      payload: {
        ...
        conversationType: "dm",
        displayName: "Ava / Ben",
        nativeConversationKey: "chat-ava-ben",
        service: "iMessage",
        participants: [
          { sourceEntityKey: "contacts:ava" },
          { sourceEntityKey: "imessage:+14155550123" },
    ...
    },
    {
      ...
      payload: {
        ...
        content: "Can we catch up about the founder update tomorrow?",
        service: "iMessage",
        status: "read",
        isFromMe: false,
    ...
    },
    {
      ...
      payload: {
        ...
        content: "Yes, send me the notes when you have them.",
        service: "iMessage",
        status: "delivered",
        isFromMe: false,
      },
