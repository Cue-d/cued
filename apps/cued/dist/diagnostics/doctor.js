...
function tryReadMessagesDatabase() {
    ...
    try {
        ...
        return {
            ...
            remediation: "Grant Full Disk Access to the app that runs cued, then restart that app and rerun doctor.",
        };
    }
}
function getContactsPermissionCheck() {
...
function getMessagesAutomationCheck() {
    try {
...
function getLegacyAuthArtifacts() {
...
export function buildDoctorReport(db) {
    const checks = [];
