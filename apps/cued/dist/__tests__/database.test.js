...
describe("CuedDatabase", () => {
    ...
    it("manages integration states", () => {
        ...
        expect(db.getIntegrationState("linkedin", "default")).toEqual(expect.objectContaining({
            platform: "linkedin",
            account_key: "default",
    ...
    it("tracks auth sessions independently from integration state", () => {
        ...
        expect(db.getAuthSession(sessionId)).toEqual(expect.objectContaining({
            id: sessionId,
            state: "authenticated",
    ...
    it("queues, claims, and finishes sync runs", () => {
        ...
        expect(db.claimNextQueuedRun()).toEqual(expect.objectContaining({
            id: runId,
            platform: "contacts",
            account_key: "local",
            run_type: "sync",
        ...
        expect(db.listRecentRuns(1)[0]).toEqual(expect.objectContaining({
            id: runId,
            status: "completed",
        }));
