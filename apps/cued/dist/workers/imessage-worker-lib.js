...
function guessHandleType(identifier) {
...
export function resolveIMessageLoader(env = process.env, repoRoot) {
...
function loadBatchFromNativeBinary(binaryPath, options) {
    const args = [
        "imessage",
        "dump",
        "--db-path",
...
export function buildIMessageSyncBundle(options) {
    ...
    const batch = loader.kind === "native"
...
//# sourceMappingURL=imessage-worker-lib.js.map