...
MOCK_PEOPLE = [
    {"id": 1, "identifier": "+15551234567", "name": "Sarah Chen", "service": "iMessage", "is_contact": True},
    {"id": 2, "identifier": "+15559876543", "name": "Mike Thompson", "service": "iMessage", "is_contact": True},
    {"id": 3, "identifier": "+15555551234", "name": "Emily Rodriguez", "service": "iMessage", "is_contact": True},
    {"id": 4, "identifier": "+15552223333", "name": "Alex Kim", "service": "iMessage", "is_contact": True},
    {"id": 5, "identifier": "+15554445555", "name": "Jordan Wright", "service": "iMessage", "is_contact": True},
    {"id": 6, "identifier": "+15556667777", "name": "David Park", "service": "iMessage", "is_contact": True},
    {"id": 7, "identifier": "+15558889999", "name": "Lisa Martinez", "service": "iMessage", "is_contact": True},
    {"id": 8, "identifier": "taylor@gmail.com", "name": "Taylor Swift", "service": "iMessage", "is_contact": True},
    {"id": 9, "identifier": "+15551112222", "name": "Chris Evans", "service": "iMessage", "is_contact": True},
    {"id": 10, "identifier": "+15553334444", "name": "Jessica Lee", "service": "iMessage", "is_contact": True},
]

MOCK_CHATS = [
    # 1:1 chats
    {"id": 1, "identifier": "chat123456", "is_group": False, "name": "Sarah Chen", "participants": [1]},
    {"id": 2, "identifier": "chat234567", "is_group": False, "name": "Mike Thompson", "participants": [2]},
    {"id": 3, "identifier": "chat345678", "is_group": False, "name": "Emily Rodriguez", "participants": [3]},
    {"id": 4, "identifier": "chat456789", "is_group": False, "name": "Alex Kim", "participants": [4]},
    {"id": 5, "identifier": "chat567890", "is_group": False, "name": "Jordan Wright", "participants": [5]},
    {"id": 6, "identifier": "chat678901", "is_group": False, "name": "David Park", "participants": [6]},
    # Group chats
    {"id": 7, "identifier": "chat;-;789012", "is_group": True, "name": "Weekend Plans", "participants": [1, 2, 3]},
    {"id": 8, "identifier": "chat;-;890123", "is_group": True, "name": "Work Project", "participants": [4, 5, 6, 7]},
]
...
CONVERSATION_TEMPLATES = {
    1: [  # Sarah Chen - project discussion
        ...
        {"text": "It's going well! Just finished the new feature", "is_from_me": True, "minutes_ago": 55},
        {"text": "Nice! Can we catch up tomorrow to discuss next steps?", "is_from_me": False, "minutes_ago": 30},
    ],
    2: [  # Mike Thompson - casual/sports
        ...
        {"text": "We should watch the next one together. I'm hosting at my place", "is_from_me": False, "minutes_ago": 60},
    ],
    3: [  # Emily Rodriguez - professional networking
        {"text": "Thanks for the introduction to your contact at TechCorp", "is_from_me": False, "minutes_ago": 1440},
        {"text": "Happy to help! Let me know how it goes", "is_from_me": True, "minutes_ago": 1430},
        {"text": "The meeting went great! They want to move forward. Coffee next week to celebrate?", "is_from_me": False, "minutes_ago": 20},
    ],
    4: [  # Alex Kim - new contact (EOD)
        {"text": "Great meeting you at the mixer!", "is_from_me": False, "minutes_ago": 180},
        {"text": "Likewise! Would love to chat more about your startup", "is_from_me": True, "minutes_ago": 175},
    ],
    5: [  # Jordan Wright - coffee meeting (EOD)
        {"text": "Thanks for the coffee chat today", "is_from_me": False, "minutes_ago": 120},
        {"text": "Really insightful conversation about AI", "is_from_me": False, "minutes_ago": 119},
    ],
    6: [  # David Park - follow up needed
        {"text": "Let me know if you hear anything about the opening", "is_from_me": True, "minutes_ago": 10080},  # 7 days
        {"text": "Will do!", "is_from_me": False, "minutes_ago": 10070},
    ],
    7: [  # Group: Weekend Plans
        {"text": "Anyone free this Saturday?", "is_from_me": False, "minutes_ago": 240, "sender_id": 1},
        {"text": "I'm in!", "is_from_me": True, "minutes_ago": 235},
        {"text": "Same here, what's the plan?", "is_from_me": False, "minutes_ago": 230, "sender_id": 2},
        {"text": "Thinking hiking at the state park then brunch?", "is_from_me": False, "minutes_ago": 45, "sender_id": 3},
    ],
    8: [  # Group: Work Project
        {"text": "Q4 deadline is coming up", "is_from_me": False, "minutes_ago": 480, "sender_id": 4},
        ...
        {"text": "Can we sync tomorrow at 2pm?", "is_from_me": False, "minutes_ago": 90, "sender_id": 6},
    ],
}
...
def create_mock_people(db: core.AppDb) -> None:
    ...
    for person in MOCK_PEOPLE:
        db.upsert_person(
            ...
            phones=json.dumps([person["identifier"]]) if person["identifier"].startswith("+") else None,
    ...
    for chat_id, conversation in CONVERSATION_TEMPLATES.items():
        ...
        for msg in conversation:
            ...
            cursor.execute("""
                ...
                (id, chat_id, sender_id, text, timestamp, is_from_me, is_read, read_at, has_attachments, synced_at)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """, (
                message_id,
                chat_id,
...
def create_mock_actions(db: core.AppDb) -> None:
    ...
    actions = [
        ...
        },
        {
            ...
            "person_id": 3,
            "message_id": None,
            "payload": {"message_preview": "Thinking hiking at the state park?", "hours_since": 0.75},
        },
        {
            "type": "respond_to_message",
            "priority": 75,
