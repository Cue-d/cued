...
import { buildContactsSyncBundle, getNativeContactsBinaryCandidates, resolveContactsLoader, } from "../workers/contacts-worker-lib.js";
describe("contacts worker loader resolution", () => {
    ...
    it("accepts the cached contacts wrapper shape", () => {
        ...
        try {
            ...
            expect(bundle.rawEvents[0]?.payload).toEqual(expect.objectContaining({
...
//# sourceMappingURL=contacts-worker-lib.test.js.map