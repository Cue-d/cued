...
export interface SlackRTMConnectResponse {
  ok: boolean
  error?: string
...
export interface SlackRTMEvent {
  type: SlackRTMEventType
  [key: string]: unknown
}

export interface SlackRTMMessageEvent extends SlackRTMEvent {
  type: 'message'
  subtype?: string
  channel: string
  user?: string
...
export interface SlackRTMReactionEvent extends SlackRTMEvent {
...
export interface SlackRTMTypingEvent extends SlackRTMEvent {
  type: 'user_typing'
  channel: string
  user: string
}
...
export interface SlackEventHandlers {
  onMessage?: (event: SlackRTMMessageEvent) => void
  onReactionAdded?: (event: SlackRTMReactionEvent) => void
  onReactionRemoved?: (event: SlackRTMReactionEvent) => void
  onTyping?: (event: SlackRTMTypingEvent) => void
  onConnected?: () => void
